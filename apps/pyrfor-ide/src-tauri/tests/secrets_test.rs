...
mod tests {
    ...
    fn set_and_get_secret() {
        let entry = keyring::Entry::new("dev.pyrfor.ide.test", "test-key").expect("create entry");
    ...
    fn get_nonexistent_returns_no_entry() {
        let entry = keyring::Entry::new("dev.pyrfor.ide.test", "nonexistent-key-xyz")
            .expect("create entry");
    ...
    fn delete_nonexistent_is_ok() {
        let entry = keyring::Entry::new("dev.pyrfor.ide.test", "nonexistent-key-del")
            .expect("create entry");
