...
- **On GitHub:** [freeclaude `docs/architecture/`](https://github.com/pyrfor-org/freeclaude/tree/main/docs/architecture) — start at [`README.md` there](https://github.com/pyrfor-org/freeclaude/blob/main/docs/architecture/README.md).
...
Pyrfor-specific integration contracts are also summarized in [../integrations.md](../integrations.md) (in-repo) and in the [canonical architecture pack on GitHub](https://github.com/pyrfor-org/freeclaude/tree/main/docs/architecture).
