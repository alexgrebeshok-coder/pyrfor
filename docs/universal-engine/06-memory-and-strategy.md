...
> ← [05 — Tool Model](./05-tool-model.md) · далее → [07 — Safety & Governance](./07-safety-and-governance.md)
...
**Инициализация:** см. решение в [12-risks-and-decisions.md](./12-risks-and-decisions.md) — start empty или import из существующих паттернов Pyrfor.
