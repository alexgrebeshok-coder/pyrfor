---
sidebar_position: 7
sidebar_label: 07 — Безопасность и Governance
---

# 07 — Безопасность и Governance

> ← [06 — Memory & Strategy](memory-and-strategy) · далее → [08 — Multi-Model Policy](multi-model-policy)
...
Применяется модель **canonical record + suspicion score** (см. [00.5.11](00.5-algorithmic-governance#0511-decisionrecord-poisoning-canonical--suspicion-signals)):
