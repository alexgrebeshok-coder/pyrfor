...
export const DEFAULT_BRIEF_LOCALE: BriefLocale = "ru";

const STATUS_LABELS: Record<BriefLocale, Record<string, string>> = {
  ru: {
    active: "активный",
...
export function formatShortDate(
  value: string,
  locale: BriefLocale = DEFAULT_BRIEF_LOCALE
): string {
...
export function formatTaskNoun(
  count: number,
  locale: BriefLocale = DEFAULT_BRIEF_LOCALE,
  adjective?: "overdue" | "blocked" | "open"
): string {
  if (locale === "ru") {
...
export function formatRiskNoun(
  count: number,
  locale: BriefLocale = DEFAULT_BRIEF_LOCALE,
  adjective?: "open"
): string {
...
export function formatProjectNoun(
  count: number,
  locale: BriefLocale = DEFAULT_BRIEF_LOCALE
): string {
  if (locale === "ru") {
