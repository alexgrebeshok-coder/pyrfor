...
export function calculateTaskEVM(task: TaskEVMInput, currentDate: Date): TaskEVMResult {
...
function calculatePlannedPercent(
  startDate: Date | null,
  dueDate: Date | null,
  currentDate: Date
): number {
...
function sanitizeNullableMetric(value: number | null) {
