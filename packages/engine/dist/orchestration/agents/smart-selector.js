...
export class SmartAgentSelector {
    ...
    selectAgentAsync(task, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const raw = yield this.withTimeout(router.chat([
                ...
                if (parsed && KNOWN_AGENT_IDS.includes(parsed)) {
                    return parsed;
                }
    ...
    getAgentCapabilities(agentId) {
        ...
        return (_a = capabilities[agentId]) !== null && _a !== void 0 ? _a : capabilities.main;
    }
}
