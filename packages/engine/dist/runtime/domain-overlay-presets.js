...
export function createOchagOverlayManifest() {
    return {
...
export function createCeoclawOverlayManifest() {
    return {
        schemaVersion: 'domain_overlay.v1',
        domainId: 'ceoclaw',
        version: '0.1.0',
...
export function registerDefaultDomainOverlays(registry = new DomainOverlayRegistry()) {
