...
export interface UniversalEngineEvent extends EventBase {
    type: 'concept.received' | 'concept.planned' | 'concept.completed' | 'research.started' | 'research.completed' | 'critique.started' | 'critique.completed' | 'strategy.snapshot.created' | 'tool.forge.requested' | 'tool.forge.blocked' | 'extension.tool_blocked' | 'delivery.started' | 'delivery.completed' | 'delivery.failed' | 'postmortem.started' | 'postmortem.completed' | 'sandbox.run.started' | 'sandbox.run.completed' | 'git.worktree.merge.requested' | 'git.worktree.merge.completed' | 'git.worktree.merge.conflicted';
    concept_id?: string;
    parent_concept_id?: string;
    node_id?: string;
    plan_id?: string;
