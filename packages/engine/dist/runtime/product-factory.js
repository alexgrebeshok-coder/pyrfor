...
export class ProductFactory {
    ...
    buildKsReconciliationDagPreview(template, intent) {
            ...
            nodes: [
                {
                    ...
                    payload: Object.assign(Object.assign({}, basePayload), { goal: 'Load the local Object A / June 2025 reconciliation fixture package.' }),
                    retryClass: 'deterministic',
                },
                {
                    id: `${prefix}/extract`,
                    ...
                    payload: Object.assign(Object.assign({}, basePayload), { goal: 'Normalize KS-2, KS-3, contract and 1C snapshot evidence into deterministic tables.' }),
                    retryClass: 'deterministic',
                },
                {
                    id: `${prefix}/match`,
                    ...
                    payload: Object.assign(Object.assign({}, basePayload), { goal: 'Match totals, line items, names and dates across execution and source records.' }),
                    retryClass: 'deterministic',
                },
                {
                    ...
                    payload: Object.assign(Object.assign({}, basePayload), { goal: 'Produce a fixture-backed review pack with proto-lineage and evidence refs for every finding.' }),
                    retryClass: 'deterministic',
                },
                {
                    id: `${prefix}/approval`,
                    ...
                    payload: Object.assign(Object.assign({}, basePayload), { goal: 'Block final delivery until a human approves the reconciliation review pack.' }),
                    retryClass: 'human_needed',
                    timeoutClass: 'manual',
                },
                {
                    ...
                    dependsOn: [`${prefix}/approval`],
                    payload: Object.assign(Object.assign({}, basePayload), { goal: 'Write the final reconciliation report only after the review gate is approved.' }),
                },
            ],
        };
    }
