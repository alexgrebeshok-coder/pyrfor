...
export const projectToolService = {
    createTask(toolCallId, args) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const title = String((_a = args.title) !== null && _a !== void 0 ? _a : "");
            if (!title) {
                return {
                    toolCallId,
                    name: "create_task",
            ...
            const task = yield prisma.task.create({
                data: {
                    id,
                    title,
                    description: (_b = args.description) !== null && _b !== void 0 ? _b : null,
                    status: (_c = args.status) !== null && _c !== void 0 ? _c : "todo",
    ...
    createRisk(toolCallId, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const severity = (_b = args.severity) !== null && _b !== void 0 ? _b : "medium";
            const risk = yield prisma.risk.create({
                data: {
                    id: generateToolEntityId(),
                    title,
                    description: (_c = args.description) !== null && _c !== void 0 ? _c : null,
                    probability: (_d = args.probability) !== null && _d !== void 0 ? _d : "medium",
                    impact: severity,
                    severity: (_e = severityMap[severity]) !== null && _e !== void 0 ? _e : 3,
                    status: "open",
                    projectId,
                },
                include: { project: { select: { name: true } } },
    ...
    updateTask(toolCallId, args) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const taskId = String((_a = args.taskId) !== null && _a !== void 0 ? _a : "");
            if (!taskId) {
                return {
                    toolCallId,
                    name: "update_task",
            ...
            const existing = yield prisma.task.findUnique({ where: { id: taskId } });
            if (!existing) {
                return {
                    toolCallId,
                    name: "update_task",
    ...
    getProjectSummary(toolCallId, args) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    listTasks(toolCallId, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                success: true,
                result: {
                    tasks: tasks.map((task) => (Object.assign(Object.assign({}, task), { projectName: task.project.name }))),
                    count: tasks.length,
                },
    ...
    generateBrief(toolCallId, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const projectFilter = args.projectId ? { projectId: String(args.projectId) } : {};
            const now = new Date();
            const weekFromNow = new Date(now.getTime() + 7 * 24 * 60 * 60 * 1000);
            const [projects, overdueTasks, upcomingTasks, openRisks] = yield Promise.all([
                prisma.project.findMany({
                    where: Object.assign({ status: { not: "archived" } }, projectFilter),
                    select: { name: true, status: true, progress: true, health: true },
                    take: 10,
                }),
                prisma.task.findMany({
                    where: Object.assign({ status: { not: "done" }, dueDate: { lt: now } }, projectFilter),
                    select: { title: true, dueDate: true, project: { select: { name: true } } },
                    take: 5,
                }),
                prisma.task.findMany({
                    where: Object.assign({ status: { in: ["todo", "in_progress"] }, dueDate: { gte: now, lte: weekFromNow } }, projectFilter),
                    select: { title: true, dueDate: true, priority: true },
                    orderBy: { dueDate: "asc" },
                    take: 5,
                }),
                prisma.risk.findMany({
                    where: Object.assign({ status: "open" }, projectFilter),
