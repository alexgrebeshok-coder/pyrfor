export function getProposalSafetyProfile(proposal) {
...
export function buildApplySafetySummary(proposal) {
    const profile = getProposalSafetyProfile(proposal);
    return Object.assign(Object.assign({}, profile), { operatorDecision: "manual_apply", postApplyState: profile.executionMode === "preview_only" ? "draft_only" : "guarded_execution" });
}
