...
import type { NotificationItem, Priority, Project, Risk, Task, TeamMember } from '../types/types';
export type AIAdapterMode = "mock" | "gateway" | "provider";
export type AIWorkspaceMode = "auto" | AIAdapterMode | "local";
export type AIRunStatus = "queued" | "running" | "needs_approval" | "done" | "failed";
export type AIProposalState = "pending" | "applied" | "dismissed";
export type AIApplyExecutionStatus = "executing" | "executed" | "failed";
export type AIActionType = "create_tasks" | "update_tasks" | "reschedule_tasks" | "raise_risks" | "draft_status_report" | "notify_team";
export type AIAgentKind = "analyst" | "planner" | "reporter" | "researcher";
export type AIAgentCategory = "auto" | "strategic" | "planning" | "monitoring" | "financial" | "knowledge" | "communication" | "special";
export type AIContextType = "portfolio" | "project" | "tasks";
export type AIApplySafetyLevel = "low" | "medium" | "high";
export type AIApplyExecutionMode = "preview_only" | "guarded_patch" | "guarded_communication";
export type AICompensationMode = "replace_draft" | "follow_up_patch" | "close_or_correct" | "send_correction_notice";
export type AIQuickActionKind = "summarize_portfolio" | "analyze_project" | "suggest_tasks" | "draft_status_report" | "triage_tasks";
...
export type AIActionProposal = AICreateTasksProposal | AIUpdateTasksProposal | AIRescheduleTasksProposal | AIRaiseRisksProposal | AIDraftStatusReportProposal | AINotifyTeamProposal;
