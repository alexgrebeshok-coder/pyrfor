...
exports.buildProjectPlanFactSummary = buildProjectPlanFactSummary;
exports.buildPortfolioPlanFactSummary = buildPortfolioPlanFactSummary;
exports.summarizeProjectPlanFactForBrief = summarizeProjectPlanFactForBrief;
function buildProjectPlanFactSummary(snapshot, projectId, options = {}) {
...
function buildPortfolioPlanFactSummary(snapshot, options = {}) {
    const referenceDate = toDate(options.referenceDate ?? snapshot.generatedAt);
    ...
    const topSignals = projects
        .flatMap((project) => project.warnings.map((warning) => ({
        ...warning,
...
function summarizeProjectPlanFactForBrief(summary) {
    return {
