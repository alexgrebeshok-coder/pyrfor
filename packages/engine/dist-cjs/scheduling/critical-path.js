...
exports.normalizeDependencyType = normalizeDependencyType;
exports.getTaskDurationDays = getTaskDurationDays;
exports.getTaskStartDate = getTaskStartDate;
exports.getTaskFinishDate = getTaskFinishDate;
...
function getDayOffset(date, anchor) {
...
function getTaskFinishDate(task) {
...
function prepareTasks(tasks, projectStart) {
    ...
    const anchor = normalizedProjectStart ??
        tasks.reduce((minDate, task) => {
...
function calculateCriticalPath(input) {
    ...
    const projectEndIndex = projectEnd && Number.isFinite(projectEnd.getTime())
        ...
        : null;
    let finishIndex = projectEndIndex ??
