...
exports.buildProjectGanttSnapshot = buildProjectGanttSnapshot;
const prisma_1 = require("../prisma");
const critical_path_1 = require("./critical-path");
async function buildProjectGanttSnapshot(projectId) {
    ...
    return {
        ...
        dependencies: tasks.flatMap((task) => task.dependencies.map((dependency) => ({
            ...
            type: dependency.type,
            lagDays: dependency.lagDays,
            isCritical: Boolean(metricsByTaskId.get(task.id)?.isCritical) &&
