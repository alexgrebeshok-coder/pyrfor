...
exports.analyzeEvidenceRecord = analyzeEvidenceRecord;
const fusion_1 = require("./fusion");
const service_1 = require("./service");
const MAX_FUSION_SCAN = 100;
async function analyzeEvidenceRecord(recordId, deps = {}) {
    const loadRecord = deps.loadRecord ?? service_1.getEvidenceRecordById;
...
async function loadRelevantFusionFact(record, deps) {
    if (record.entityType !== "work_report" && record.entityType !== "video_fact") {
        return null;
    }
    const loadFusion = deps.loadFusion ?? fusion_1.getEvidenceFusionOverview;
