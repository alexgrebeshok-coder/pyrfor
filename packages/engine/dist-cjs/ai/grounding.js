...
exports.buildChatGrounding = buildChatGrounding;
exports.attachRunGrounding = attachRunGrounding;
...
function buildChatGrounding(bundle) {
...
function attachRunGrounding(result, input) {
...
function isOverdue(value) {
    return value <= (0, date_fns_1.format)(new Date(), "yyyy-MM-dd");
}
