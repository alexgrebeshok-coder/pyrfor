...
exports.buildDashboardStateFromExecutiveSnapshot = buildDashboardStateFromExecutiveSnapshot;
const normalizers_1 = require("../client/normalizers");
function buildDashboardStateFromExecutiveSnapshot(snapshot) {
    ...
    return (0, normalizers_1.buildDashboardStateFromApi)({
