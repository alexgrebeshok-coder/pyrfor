...
exports.CollaborationPlanSchema = exports.CollaborationStepSchema = void 0;
exports.buildDynamicPlan = buildDynamicPlan;
exports.shouldCollaborate = shouldCollaborate;
const zod_1 = require("zod");
const logger_1 = require("../../observability/logger");
// ============================================
// Schemas
// ============================================
exports.CollaborationStepSchema = zod_1.z.object({
    agentId: zod_1.z.string(),
    focus: zod_1.z.string(),
    role: zod_1.z.enum(["support", "reviewer", "synthesizer"]).default("support"),
});
exports.CollaborationPlanSchema = zod_1.z.object({
    collaborative: zod_1.z.boolean(),
    leaderAgentId: zod_1.z.string(),
    reason: zod_1.z.string(),
    steps: zod_1.z.array(exports.CollaborationStepSchema),
});
// ============================================
...
// ============================================
function contextComplexity(input) {
    const ctx = input.context ?? {};
    return ((Array.isArray(ctx.projects) ? ctx.projects.length : 0) +
...
function buildDynamicPlan(input) {
    ...
    if (totalComplexity >= 4 && leaderAgentId !== DEFAULT_REVIEWER) {
        logger_1.logger.info("dynamic-planner: applying default reviewer fallback", {
    ...
    logger_1.logger.warn("dynamic-planner: no rule for agent, single-agent mode", {
        agentId: leaderAgentId,
        totalComplexity,
    });
    return {
 ...
 */
function shouldCollaborate(input) {
