...
exports.buildMockFinalRun = buildMockFinalRun;
exports.applyMockProposal = applyMockProposal;
exports.createMockAIAdapter = createMockAIAdapter;
        ...
        tasks: [
            {
                ...
                dueDate: (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 2), "yyyy-MM-dd"),
            ...
            },
            {
                ...
                dueDate: (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 4), "yyyy-MM-dd"),
                priority: "high",
            ...
            },
            {
                ...
                assignee: primaryOwner,
                dueDate: (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 6), "yyyy-MM-dd"),
                priority: "medium",
...
function buildUpdateTasksProposal(context) {
    ...
    const taskUpdates = openTasks.slice(0, 3).map((task, index) => ({
        ...
        dueDate: (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), index + 2), "yyyy-MM-dd"),
...
function buildRescheduleTasksProposal(context) {
    ...
    const taskReschedules = candidates.map((task, index) => ({
        ...
        newDueDate: (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), index + 3), "yyyy-MM-dd"),
...
function buildHighlights(kind, context) {
    ...
    const overdueTasks = openTasks.filter((task) => task.dueDate <= (0, date_fns_1.format)(new Date(), "yyyy-MM-dd"));
...
function buildMockFinalRun(input, seed) {
...
function applyMockProposal(run, proposalId) {
    return (0, action_engine_1.applyAIProposal)(run, proposalId);
}
