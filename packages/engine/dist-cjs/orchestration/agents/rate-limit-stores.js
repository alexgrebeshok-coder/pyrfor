...
exports.createUpstashRateLimitStore = createUpstashRateLimitStore;
exports.createIoredisRateLimitStore = createIoredisRateLimitStore;
exports.createRateLimitStoreFromEnv = createRateLimitStoreFromEnv;
...
function createUpstashRateLimitStore(options) {
    ...
    return {
        async incrementWindow(key, windowMs) {
            ...
            const response = await fetchWithTimeout(fetchImpl, pipelineUrl, {
                method: "POST",
                headers: {
 ...
 * we read `PTTL`.
 */
function createIoredisRateLimitStore(client) {
    return {
        async incrementWindow(key, windowMs) {
 ...
 */
function createRateLimitStoreFromEnv(env = process.env) {
