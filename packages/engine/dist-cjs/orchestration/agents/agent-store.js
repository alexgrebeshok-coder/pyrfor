...
exports.AgentSessionManager = exports.AGENT_CONFIGS = void 0;
exports.getAgentSessionManager = getAgentSessionManager;
const file_manager_1 = require("../../data/file-manager");
// ============================================
...
class AgentSessionManager {
    ...
    async createSession(data) {
        ...
        const sessions = (0, file_manager_1.readJsonFile)(SESSIONS_FILE, []);
        sessions.push(session);
        (0, file_manager_1.writeJsonFile)(SESSIONS_FILE, sessions);
        return session;
    }
    /**
     * Start session
    ...
    async startSession(id) {
        return (0, file_manager_1.updateInJsonArray)(SESSIONS_FILE, (s) => s.id === id, (s) => ({
            ...s,
            status: 'running',
     ...
     * Complete session
     */
    async completeSession(id, result, tokens, cost) {
        return (0, file_manager_1.updateInJsonArray)(SESSIONS_FILE, (s) => s.id === id, (s) => ({
            ...s,
            status: 'completed',
            result,
     ...
     */
    async getSession(id) {
        return (0, file_manager_1.findInJsonArray)(SESSIONS_FILE, (s) => s.id === id);
    }
    /**
     * Get recent sessions
     */
    async getRecentSessions(limit = 20) {
        return (0, file_manager_1.queryJsonArray)(SESSIONS_FILE, {
     ...
     */
    async getSessionsByAgent(agentId, limit = 10) {
        return (0, file_manager_1.queryJsonArray)(SESSIONS_FILE, {
     ...
     */
    async clearOldSessions(days = 30) {
        const cutoff = new Date();
        cutoff.setDate(cutoff.getDate() - days);
        const sessions = (0, file_manager_1.readJsonFile)(SESSIONS_FILE, []);
        const initialLength = sessions.length;
        const filtered = sessions.filter((s) => new Date(s.createdAt) >= cutoff);
        (0, file_manager_1.writeJsonFile)(SESSIONS_FILE, filtered);
...
function getAgentSessionManager() {
    if (!_sessionManager) {
