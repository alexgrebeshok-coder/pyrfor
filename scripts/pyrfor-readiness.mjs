...
run('Engine readiness tests', 'pnpm', [
  ...
  'src/runtime/artifact-model.test.ts',
  'src/runtime/event-ledger.test.ts',
  'src/runtime/approval-flow.test.ts',
  'src/runtime/verifier-lane.test.ts',
  'src/runtime/github-delivery-evidence.test.ts',
  'src/runtime/github-delivery-plan.test.ts',
  'src/runtime/github-delivery-apply.test.ts',
  'src/runtime/openapi-contract.test.ts',
  'src/runtime/product-factory.test.ts',
  'src/runtime/runtime-orchestration.test.ts',
  'src/runtime/domain-overlay-presets.test.ts',
  'src/runtime/telegram/handlers.test.ts',
